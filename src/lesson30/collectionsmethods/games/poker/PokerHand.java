package lesson30.collectionsmethods.games.poker;

import lesson30.collectionsmethods.Card;
...
public class PokerHand {
    ...
    private void setRank(int faceCount) {
        ...
        switch (faceCount) {
            ...
            case 2 -> {
                ...
                else if (score == Ranking.FOUR_OF_A_KIND) score = Ranking.FULL_HOUSE;
    ...
    public void evalHand() {
        ...
        faceList.forEach(face -> {
            if (!duplicatedFaceCards.contains(face) &&
                    Collections.frequency(faceList, face) > 1) {
                duplicatedFaceCards.add(face);
